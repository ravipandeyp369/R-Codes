...
prop.table(table(train1$reachedontime))
...
#I will chose Stepwise model because it has fairly better accuracy 
# than the base model and includes only significant variables
